        ...
        <div className="grid grid-cols-2 lg:mx-24 mt-4 mx-3 md:mt-24">
            <div className=" md:w-[554px] col-span-2 lg:col-span-1 items-center content-center">
                <div className="lg:pl-4">
                    <p className="font-bold">ResortScape</p>
            ...
            <div className="lg:col-span-1 col-span-2 bg-white">
                <Swiper
                    ...
                    <SwiperSlide><img className='w-auto h-auto rounded-lg' src="https://i.ibb.co/tqsgRvV/photo-1610641818989-c2051b5e2cfd.jpg" alt="" /></SwiperSlide>
                    <SwiperSlide><img className='w-auto h-auto rounded-lg' src="https://i.ibb.co/5K25F3Z/photo-1617859047452-8510bcf207fd.jpg" alt="" /></SwiperSlide>
